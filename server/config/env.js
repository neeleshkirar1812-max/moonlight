...
export const ENV = {
  ...
  MONGODB_URI: process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/lumiere_studios',
  JWT_SECRET: process.env.JWT_SECRET || 'lumiere_luxury_jwt_super_secret_key_2026_!@#$%^',
  JWT_EXPIRES_IN: process.env.JWT_EXPIRES_IN || '7d',
  JWT_REFRESH_SECRET: process.env.JWT_REFRESH_SECRET || 'lumiere_refresh_secret_key_luxury_wedding_987654321',
  JWT_REFRESH_EXPIRES_IN: process.env.JWT_REFRESH_EXPIRES_IN || '30d',
  
  CLOUDINARY_CLOUD_NAME: process.env.CLOUDINARY_CLOUD_NAME || 'lumiere-studios',
  ...
  EMAILJS_SERVICE_ID: process.env.EMAILJS_SERVICE_ID || 'service_lumiere',
  EMAILJS_TEMPLATE_ID: process.env.EMAILJS_TEMPLATE_ID || 'template_lumiere',
