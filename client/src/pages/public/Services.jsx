            ...
            {services.map((service, index) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-3xl p-6 sm:p-10 flex flex-col justify-between space-y-6 sm:space-y-8 relative overflow-hidden border border-amber-900/15 hover:border-amber-600/50 shadow-md hover:shadow-2xl transition-all"
                >
                  {service.isPopular && (
