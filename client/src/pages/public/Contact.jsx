  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-neutral-900 pt-24 sm:pt-28 pb-16 sm:pb-20 px-3 sm:px-6 lg:px-8 w-full max-w-full overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-8 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 font-sans">
          {/* Contact Details */}
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 space-y-6 border border-amber-900/15 shadow-xl text-neutral-900">
              ...
              <ul className="space-y-4 text-sm font-sans">
                <li className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-500 block uppercase font-sans font-medium tracking-wide">Principal Registered Office</span>
                    <strong className="text-neutral-900 font-serif text-sm block">C 37, Pallavi Nagar, Rohit Nagar, Bawaria Kalan</strong>
                    <p className="text-xs text-neutral-600 font-normal font-sans">Bhopal, Madhya Pradesh - 462039</p>
                  </div>
                </li>
                ...
                <li className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-500 block uppercase font-sans font-medium tracking-wide">Studio Branch Units</span>
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-500 block uppercase font-sans font-medium tracking-wide">Direct & WhatsApp</span>
                    <a href="https://api.whatsapp.com/send?phone=919229229323" target="_blank" rel="noreferrer" className="text-neutral-900 hover:text-emerald-700 font-sans font-semibold text-sm block">
                      +91 92292 29323
                    </a>
                    <a href="tel:+919039583534" className="text-xs text-neutral-600 font-sans">
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-500 block uppercase font-sans font-medium tracking-wide">Instagram</span>
                    <a href="https://instagram.com/moonlight_production__" target="_blank" rel="noreferrer" className="text-neutral-900 hover:text-pink-700 font-sans font-semibold text-sm">
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-500 block uppercase font-sans font-medium tracking-wide">YouTube Cinema</span>
                    <a href="https://www.youtube.com/@moonlightproductions_films" target="_blank" rel="noreferrer" className="text-neutral-900 hover:text-red-700 font-sans font-semibold text-sm">
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-500 block uppercase font-sans font-medium tracking-wide">Official Linktree</span>
                    <a href="https://linktr.ee/moonlight_photography_in" target="_blank" rel="noreferrer" className="text-neutral-900 hover:text-amber-700 font-sans text-xs font-semibold">
              ...
              <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-600/25 space-y-1.5 font-sans text-[11px] text-neutral-700">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-3xl p-6 sm:p-10 border border-amber-900/15 shadow-xl space-y-6 text-neutral-900">
              <div>
                ...
                <p className="text-xs text-neutral-600 mt-1 font-sans">For wedding dates availability, collaborations, or custom packages</p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-4 text-xs font-sans">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-neutral-800 font-semibold uppercase text-[10.5px]">Your Name *</label>
                    <input
                      type="text"
                      required
                      ...
                      className="w-full bg-[#FAF8F5] border border-neutral-300 rounded-xl px-4 py-3 text-neutral-900 placeholder-neutral-400 focus:border-amber-600 focus:bg-white focus:outline-none shadow-sm font-sans"
                    />
                  </div>

                  <div className="space-y-1.5">
                    <label className="text-neutral-800 font-semibold uppercase text-[10.5px]">Email Address *</label>
                    <input
                      type="email"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-neutral-800 font-semibold uppercase text-[10.5px]">Phone Number</label>
                    <input
                      type="tel"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-neutral-800 font-semibold uppercase text-[10.5px]">Subject</label>
                    <input
                      type="text"
                ...
                <div className="space-y-1.5">
                  <label className="text-neutral-800 font-semibold uppercase text-[10.5px]">Message *</label>
                  <textarea
                    rows={4}
                    required
                    ...
                    className="w-full bg-[#FAF8F5] border border-neutral-300 rounded-2xl p-4 text-neutral-900 placeholder-neutral-400 focus:border-amber-600 focus:bg-white focus:outline-none leading-relaxed shadow-sm font-sans"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 rounded-full bg-gold-gradient text-neutral-950 font-bold text-xs shadow-gold-subtle hover:brightness-105 active:scale-95 transition-all flex items-center justify-center disabled:opacity-50 btn-shimmer font-sans"
                >
