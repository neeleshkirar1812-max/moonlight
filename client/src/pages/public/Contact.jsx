      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="luxury-card rounded-3xl p-8 space-y-6 border border-white/10">
              ...
              <ul className="space-y-5 text-sm">
                <li className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-400 block uppercase font-mono">Head Atelier</span>
                    <strong className="text-white font-serif">Moonlight Production & Films, Central Studio</strong>
                  </div>
                </li>
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    ...
                    <a href="https://api.whatsapp.com/send?phone=919229229323" target="_blank" rel="noreferrer" className="text-white hover:text-emerald-400 font-mono font-bold">
                      +91 92292 29323
                    </a>
                  </div>
                </li>
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    ...
                    <a href="https://instagram.com/moonlight_production__" target="_blank" rel="noreferrer" className="text-white hover:text-gold-300 font-mono">
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    ...
                    <a href="https://www.youtube.com/@moonlightproductions_films" target="_blank" rel="noreferrer" className="text-white hover:text-gold-300 font-mono">
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-400 block uppercase font-mono">Linktree</span>
          ...
          <div className="lg:col-span-7">
            <div className="luxury-card rounded-3xl p-8 sm:p-12 border border-white/10 space-y-6">
              <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 text-xs">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-obsidian-500 border border-white/15 rounded-xl px-4 py-3 text-white focus:border-gold-400 focus:outline-none"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-neutral-300 font-semibold uppercase">Subject</label>
                    <input
                      type="text"
                ...
                <div className="space-y-1.5">
                  <label className="text-neutral-300 font-semibold uppercase">Message *</label>
                  <textarea
                    rows={5}
                    required
                    ...
                    className="w-full bg-obsidian-500 border border-white/15 rounded-2xl p-4 text-white focus:border-gold-400 focus:outline-none leading-relaxed"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 rounded-full bg-gold-gradient text-black font-bold text-xs uppercase tracking-widest shadow-gold-subtle hover:brightness-110 transition-all flex items-center justify-center disabled:opacity-50 btn-shimmer"
                >
