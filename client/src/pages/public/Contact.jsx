            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 space-y-6 border border-amber-900/15 shadow-xl text-neutral-900">
              ...
              <ul className="space-y-4 text-sm">
                <li className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <span className="text-xs text-neutral-500 block uppercase font-mono">Studio Hub</span>
                    <strong className="text-neutral-900 font-serif text-base">Moonlight Production & Films</strong>
                    <p className="text-xs text-neutral-600 font-normal">Bhopal • Maheshwar • Udaipur • All-India Shoots</p>
                  </div>
                </li>
                ...
                <li className="flex items-center space-x-3.5">
                  ...
                  <div>
                    ...
                    <a href="https://api.whatsapp.com/send?phone=919229229323" target="_blank" rel="noreferrer" className="text-neutral-900 hover:text-emerald-700 font-mono font-bold text-sm">
                      +91 92292 29323
                    </a>
                  </div>
                </li>
