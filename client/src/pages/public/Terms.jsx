    ...
    <div className="min-h-screen bg-[#FAF8F5] text-neutral-900 pt-32 pb-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="prose max-w-none text-xs sm:text-sm text-neutral-700 font-normal leading-relaxed space-y-6">
          ...
          <h3 className="font-serif text-xl font-bold text-neutral-900 pt-4">1. Date Retention & Advance</h3>
          <p>
          ...
          <h3 className="font-serif text-xl font-bold text-neutral-900 pt-4">2. Artistic Discretion & Color Grading</h3>
          <p>
