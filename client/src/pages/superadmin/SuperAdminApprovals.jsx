...
const defaultPendingApprovals = [
  {
    id: 'REQ-101',
    name: 'Kabir Singh',
    email: 'kabir.drone@moonlightproduction.com',
    phone: '+91 98260 44556',
    role: 'employee',
    designation: '4K Commercial Drone Pilot',
    createdBy: 'HR Manager (Pooja Sharma)',
  ...
  },
  {
    id: 'REQ-102',
    name: 'Priya Mehta',
    email: 'priya.candid@moonlightproduction.com',
    phone: '+91 97555 12340',
    role: 'employee',
    designation: 'Senior Candid Master',
    createdBy: 'HR Manager (Pooja Sharma)',
    department: 'Royal Portraiture',
    requestedAt: '2026-08-25T15:10:00Z',
    status: 'pending',
  },
  {
    id: 'REQ-103',
    ...
    role: 'customer',
    designation: 'Client (3-Day Udaipur Wedding)',
