...
const WhatsAppFloatingButton = ({
  ...
  return (
    <a
      ...
      className="fixed bottom-20 sm:bottom-6 left-4 sm:left-6 z-40 flex items-center space-x-2 bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-105 group border border-emerald-400/40"
    >
